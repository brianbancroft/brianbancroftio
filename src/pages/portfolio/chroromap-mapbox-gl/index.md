...
This is a quick 25-minute chropleth, and the first entry in a series where I make the same thing across different platforms. You can [Visit the page here](http://mapbox-basic-chropleth.bancroft.io/), and take the code yourself below.
